$(function(){
  ...
  var Fireworks = function(){
    ...
    self.init = function(){
      ...
      self.canvasContainer = $('#fireworkContainer');

      var canvasContainerDisabled = document.getElementById('fireworkContainer');
      self.canvas.onselectstart = function() {
        return false;
      };

      self.canvas.width = self.cw = $(window).width();
      self.canvas.height = self.ch = $(window).height();
    ...
    Firework.prototype.update = function(index){
      ...
      if(this.hitX && this.hitY){
        ...
        // audioCtx.playSound('explosion0'+randExplosion);
    ...
    self.bindEvents = function(){
      ...
      $(self.canvas).on('mousedown', function(e){
        ...
        // audioCtx.playSound('launch0'+randLaunch);
